...
namespace WargaminAPI.WoW
{
    public class PlayerInfo : Info
    {
        public Player FindPlayer(string searchNickname)
        {
            ...
            urlRequest = resourceMan.GetString("url_find_player_WOW") + appID + "&search=" + searchNickname;
            Player player = null;
        ...
        public Statistics GetStatistic(Player currentPlayer)
        {
            ...
            urlRequest = resourceMan.GetString("uri_get_stat_WOW") + appID + "&account_id=" + playerStatistic.PlayerId;
            string resultResponse = GetResponse(urlRequest);
